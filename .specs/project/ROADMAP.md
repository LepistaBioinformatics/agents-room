...
| **Skill / command creation from UI** | ✅ Done | Create + edit SKILL.md / command .md; duplicate-before-edit for installed skills; inline editor in detail drawers; "+" in GroupBox headers |
