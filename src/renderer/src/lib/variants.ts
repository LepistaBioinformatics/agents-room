...
export const cardShell = cva(
  'relative flex flex-col border border-t-2 select-none transition-all duration-150',
  {
    variants: {
      kind: {
        agent:   'bg-ag-card   border-zinc-700/50     border-t-indigo-500/70  hover:border-zinc-500/60   hover:border-t-indigo-400/90',
    ...
    compoundVariants: [
      { kind: 'agent',   selected: true, class: 'border-zinc-600/70 border-t-indigo-400 ring-1 ring-indigo-500/25' },
